...
- You can ignore the param: `CMAKE_BUILD_TYPE = `
- You need to apply the param: `LCS_PYTHON_EXECUTABLE = /opt/homebrew/bin/python3`
...
```bash
python3 PythonBindings/tests/test_cloth_soft_rigid_coupling.py --headless
```