...
void dcd_cloth_ball(std::vector<lcs::Initializer::ShellInfo>& shell_list)
{
    ...
    //     }
    // });
    shell_list.push_back({ .model_name = obj_mesh_path + "bowl/bowl.obj",
...
void cloth_bottle4(std::vector<lcs::Initializer::ShellInfo>& shell_list)
{
    ...
    shell_list.push_back({ .model_name = obj_mesh_path + "square2K.obj",
        ...
        .scale = luisa::make_float3(0.2f),
        .fixed_point_list = {} });
    shell_list.push_back({ .model_name = obj_mesh_path + "bowl/bottle4.obj",
...
void load_scene(std::vector<lcs::Initializer::ShellInfo>& shell_list)
{
    ...
    case 5: {
        rigid_body_vf_unit_case(shell_list);
        break;
    };
    case 8: {
