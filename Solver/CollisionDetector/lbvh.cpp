...
void LBVH::compile(luisa::compute::Device& device)
{
    ...
    fn_reduce_aabb_2_pass = device.compile<1>([sa_block_aabb = lbvh_data->sa_block_aabb.view()]() {
        luisa::compute::set_block_size(256);
        const Uint vid = luisa::compute::dispatch_id().x;
    ...
    fn_reduce_vert_tree_global_aabb = device.compile<1>([&reduce_aabb_1_pass_template](
    ...
    fn_reduce_edge_tree_global_aabb = device.compile<1>([&reduce_aabb_1_pass_template](
                                                            const Var<luisa::compute::BufferView<float3>> input_position,
    ...
    fn_reduce_face_tree_global_aabb = device.compile<1>([&reduce_aabb_1_pass_template](
                                                            const Var<luisa::compute::BufferView<float3>> input_position,
    ...
    fn_reset_tree = device.compile<1>([sa_is_healthy = lbvh_data->sa_is_healthy.view(),
    ...
    fn_compute_mortons = device.compile<1>([sa_block_aabb = lbvh_data->sa_block_aabb.view(),
                                               sa_leaf_center = lbvh_data->sa_leaf_center.view(),
    ...
    fn_apply_sorted = device.compile<1>([sa_sorted_get_original = lbvh_data->sa_sorted_get_original.view(),
                                            sa_morton = lbvh_data->sa_morton.view(),
    ...
    fn_build_inner_nodes = device.compile<1>([sa_morton_sorted = lbvh_data->sa_morton_sorted.view(),
                                                 sa_children = lbvh_data->sa_children.view(),
                                                 sa_parrent = lbvh_data->sa_parrent.view(),
    ...
    fn_check_construction = device.compile<1>([sa_children = lbvh_data->sa_children.view(),
                                                  sa_parrent = lbvh_data->sa_parrent.view(),
                                                  sa_is_healthy = lbvh_data->sa_is_healthy.view()]() {
        const Uint nid = dispatch_id().x;
    ...
    // Refit
    fn_update_vert_tree_leave_aabb = device.compile<1>([sa_sorted_get_original = lbvh_data->sa_sorted_get_original.view(),
    ...
    fn_update_edge_tree_leave_aabb = device.compile<1>([sa_sorted_get_original = lbvh_data->sa_sorted_get_original.view(),
                                                           sa_node_aabb = lbvh_data->sa_node_aabb.view(),
                                                           num_inner_nodes](
                                                           const Var<luisa::compute::BufferView<float3>> sa_x_start,
                                                           const Var<luisa::compute::BufferView<float3>> sa_x_end,
    ...
    fn_update_face_tree_leave_aabb = device.compile<1>([sa_sorted_get_original = lbvh_data->sa_sorted_get_original.view(),
                                                           sa_node_aabb = lbvh_data->sa_node_aabb.view(),
                                                           num_inner_nodes](
                                                           const Var<luisa::compute::BufferView<float3>> sa_x_start,
                                                           const Var<luisa::compute::BufferView<float3>> sa_x_end,
    ...
    fn_clear_apply_flag = device.compile<1>([sa_apply_flag = lbvh_data->sa_apply_flag.view()]() {
        const Uint nid = dispatch_id().x;
        sa_apply_flag->write(nid, 0u);
    });

    fn_refit_tree_aabb = device.compile<1>([sa_apply_flag = lbvh_data->sa_apply_flag.view(),
                                               sa_parrent = lbvh_data->sa_parrent.view(),
                                               sa_children = lbvh_data->sa_children.view(),
                                               sa_node_aabb = lbvh_data->sa_node_aabb.view(),
                                               sa_is_healthy = lbvh_data->sa_is_healthy.view(),
...
#define STACKLESS 0
    ...
    fn_query_from_verts = device.compile<1>([num_leaves, &query_template](
    ...
    fn_query_from_edges = device.compile<1>([num_leaves, &query_template](
                                                Var<BufferView<float3>> sa_x_begin,
                                                Var<BufferView<float3>> sa_x_end,
