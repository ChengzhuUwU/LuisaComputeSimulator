...
{
template <typename T>
inline void edge_edge_distance2(const Eigen::Vector<T, 3>& ea0,
...
template <typename T>
inline void edge_edge_distance2_gradient(const Eigen::Vector<T, 3>& ea0,
                                               const Eigen::Vector<T, 3>& ea1,
                                               const Eigen::Vector<T, 3>& eb0,
                                               const Eigen::Vector<T, 3>& eb1,
...
template <typename T>
inline void edge_edge_distance2_hessian(const Eigen::Vector<T, 3>& ea0,
                                              const Eigen::Vector<T, 3>& ea1,
                                              const Eigen::Vector<T, 3>& eb0,
                                              const Eigen::Vector<T, 3>& eb1,
