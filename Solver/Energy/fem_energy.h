...
constexpr Scalar calcFirstLame(const Scalar youngs_modulus, const Scalar poisson_ratio)
{
...
/// \details Reference: [1]
template <typename Scalar>
constexpr Scalar calcSecondLame(const Scalar youngs_modulus, const Scalar poisson_ratio)
{
