...
inline constexpr uint get_num_vertices() { return 8; }
inline constexpr uint get_num_faces() { return 12; }
inline constexpr std::vector<Int3> get_box_faces()
{
    return std::vector<Int3>{
        Int3({0, 1, 3}), Int3({0, 2, 3}),
        Int3({4, 5, 7}), Int3({4, 6, 7}),
        Int3({2, 3, 6}), Int3({3, 6, 7}),
        Int3({0, 1, 4}), Int3({1, 4, 5}),
        Int3({1, 3, 5}), Int3({3, 5, 7}),
        Int3({0, 2, 4}), Int3({2, 4, 6})
    };
}
template <typename T>
