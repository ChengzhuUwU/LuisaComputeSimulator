...
inline void extract_surface_face_and_vert_from_tets(const std::vector<Float3>& input_position,
...
inline void extract_edges_from_surface(const std::vector<Int3>& input_faces,
