...
struct CollisionData : SimulationType
{
    ...
    static consteval uint get_vv_count_offset() { return 0; }
    static consteval uint get_ve_count_offset() { return 1; }
    static consteval uint get_vf_count_offset() { return 2; }
    static consteval uint get_ee_count_offset() { return 3; }
